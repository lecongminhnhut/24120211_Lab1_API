...
Liên kết Hugging Face: google/gemma-2-2b-it
...
5. Hướng dẫn chạy chương trình
   ...
   Mở file Notebook [W2 - NOTEBOOK] API.ipynb trên Colab.

Chạy toàn bộ các cell để cài đặt Ollama, tạo mô hình tùy chỉnh và mở tunnel kết nối.

Sao chép đường link Public hiện ra ở cell cuối cùng (ví dụ: https://...a.free.pinggy.link).

Bước 2: Khởi động API Gateway (Local)
Mở file main.py ở máy tính cá nhân.

Dán đường link vừa sao chép vào biến COLAB_URL.
